...
train_generator, val_generator, test_generator = get_generators(use_augmentation=True)
...
fraction_of_positives, mean_predicted_value = calibration_curve(correct_mask, prob_pos, n_bins=10)
...
# Ablation
results = {"Full Model": acc_full, "No Dropout": acc_no_dropout, "No Augmentation": acc_no_aug}
